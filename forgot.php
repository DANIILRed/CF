...
if(isset($data['forgot'])){
    ...
    if($user){
        ...
        $url = $site_url.'http://localhost/userregistration/newpass.php?key='.$key;
...
<body>
    ...
    <div class="container">
        <div class="col-md-6 login-left">
            <h2 class="header_log" >Востановление пароля</h2>
            <form action="forgot.php" method="post">
                ...
                <div class="btn-field">
                    ...
                    <button  class="disable" type="submit" name="forgot">Отправить письмо </a></button>
                </div>
            </form>
        </div>
