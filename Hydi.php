...
try {
    ...
    $result = $pdo->query("SELECT * FROM hydi");
...
/*
$sql = "
CREATE TABLE IF NOT EXISTS Hydi
(
...
$sql = 
" INSERT INTO hydi (`name`, `price`, `image`) 
VALUES 
('Худи Орландо Мэджик', '5400 руб.', 'img/Hydi/hydi_1.avif'),
('Худи Митчелл и Несс Ройял', '4800 руб.', 'img/Hydi/hydi_2.avif'),
('Кофта Орландо Мэджик', '3100 руб.', 'img/Hydi/hydi_5.avif'),
('Худи Орландо Мэджик', '5100 руб.', 'img/Hydi/hydi_3.avif'),
('Худи Митчелл и Несс', '5700 руб.', 'img/Hydi/hydi_6.avif'),
('Худи Орландо NBA', '5700 руб.', 'img/Hydi/hydi_7.avif'),
('Худи Орландо Мэджик Хард', '4700 руб.', 'img/Hydi/hydi_8.avif'),
('Худи Орландо Fade', '3900 руб.', 'img/Hydi/hydi_9.avif'),
('Худи Волшебная сила Орландо', '4900 руб.', 'img/Hydi/hydi_4.avif');
";
...
<body>
    ...
    <!--Jersey__Catalog-->
    <div class="container">
        <h2 class="Jersey__header">Кофты</h2>
